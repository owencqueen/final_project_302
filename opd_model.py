...
def train_obo(x_train, y_train, bs = 20, ep = 2, mod_name = 'obo.model'):
	...
	model.add(Conv2D(39, kernel_size = (2,2), activation='relu', padding='same', input_shape = (2, 12, 1 )))
	model.add(BatchNormalization())
	model.add(Conv2D(39, kernel_size = (2,2), activation='relu', padding='same'))
	model.add(BatchNormalization())
	model.add(Conv2D(24, kernel_size = (1,1), activation='relu', padding='same'))
